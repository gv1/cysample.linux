...
#define P1_6_DM_ALG_HIZ         (0x00u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_DIG_HIZ         (0x01u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_RES_UP          (0x02u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_RES_DWN         (0x03u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_OD_LO           (0x04u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_OD_HI           (0x05u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_STRONG          (0x06u << P1_6_DRIVE_MODE_SHIFT)
#define P1_6_DM_RES_UPDWN       (0x07u << P1_6_DRIVE_MODE_SHIFT)
