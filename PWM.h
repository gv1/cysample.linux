...
/* Signal present */
#define PWM_QUAD_INDEX_SIGNAL_PRESENT      (1lu)
#define PWM_QUAD_STOP_SIGNAL_PRESENT       (1lu)
...
/* Signal present */
#define PWM_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define PWM_TC_COUNT_SIGNAL_PRESENT        (1lu)
#define PWM_TC_START_SIGNAL_PRESENT        (1lu)
#define PWM_TC_STOP_SIGNAL_PRESENT         (1lu)
#define PWM_TC_CAPTURE_SIGNAL_PRESENT      (1lu)
...
#define PWM_PWM_COUNT_SIGNAL_PRESENT       (1lu)
#define PWM_PWM_START_SIGNAL_PRESENT       (1lu)
...
#define PWM_PWM_MODE_CENTER                (PWM_CC_MATCH_INVERT       |   \
                                                         PWM_OVERLOW_NO_CHANGE     |   \
                                                         PWM_UNDERFLOW_CLEAR)
#define PWM_PWM_MODE_ASYM                  (PWM_CC_MATCH_NO_CHANGE    |   \
                                                         PWM_OVERLOW_SET           |   \
                                                         PWM_UNDERFLOW_CLEAR )
